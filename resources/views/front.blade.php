...
<head>
    ...
    body{
        background-size:100%;
        background-image: url('images/hjk.jpg')
    }
    nav{background:#FF4500}
    ...
    <div id="app">
      <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top ">
            <div class="container-fluid">
                ...
                <i class="fab fa-acquisitions-incorporated"></i> Roesman Store
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item" style="margin-right:10px">
                                ...
                                <i class="fab fa-acquisitions-incorporated"></i> Home</a>
                        </li>
                        @if (Auth::check())
                        ...
                        <li class="nav-item dropdown ml-auto" style="margin-right:10px">
                            <a class="nav-link dropdown-toggle   " href="#" id="navbarDropdown"
                                role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="col-md-4 ml-auto ">
                ...
                <form action="{{url('/')}}">
                    <select name="sorting" id="sorting" class="form-control">
                        ...
                        <option value="most_viewed">Banyak Dilihat</option>
