...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9">
			...
			<br>Stok {{$products->stock}}
			<br>Dilihat {{$products->view}}
			@if(Auth::check())
				<div class="mt-4">
			...
			<div class="mt-4">
				...
				<div class="tab-content mt-2">
					...
					@if(count($errors))
						...
						@endif
						@if(Auth::check())
						<button id="btn-add" name="btn-add" class="btn btn-primary mb-2">Leave Review</button>

							<div class="modal fade" id="addReview" aria-hidden="true">
								<div class="modal-dialog modal-lg">
									...
									<div class="modal-header">
										...
										<form id="clearForm" name="clearForm" novalidate="">
											<input type="hidden" value="{{$products->id}}" name="idproduct">
											<br>
											<span class="star-rating star-5">
												<input type="radio" name="rating" id="rate" value="1"><i></i>
												<input type="radio" name="rating" id="rate" value="2"><i></i>
												<input type="radio" name="rating" id="rate" value="3"><i></i>
												<input type="radio" name="rating" id="rate" value="4"><i></i>
												<input type="radio" name="rating" id="rate" value="5"><i></i>
											</span>	
											<br>
